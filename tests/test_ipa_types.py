...
def test_generate_all_cons_n():
    with open("test_ipa_types/IpaTypes.generate_all_cons_n().txt", "r") as f:
        all_cons_n = f.read()
    assert all_cons_n == str(IpaTypes.generate_all_cons_n())


def test_generate_all_vowels_n():
    with open("test_ipa_types/IpaTypes.generate_all_vowels_n().txt", "r") as f:
        all_vowels_n = f.read()
