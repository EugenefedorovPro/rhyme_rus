...
def test_get_voice_cons():
    with open("tests/test_ipa_types/get_voic_cons.json", "r", encoding="UTF-8") as f:
        voice_cons = json.load(f)
    assert voice_cons == str(IpaTypes.get_voice_cons())


def test_get_palatal_cons():
    with open("tests/test_ipa_types/get_palat_cons.txt", "r", encoding="UTF-8") as f:
        palatal_cons = f.read()
...
def test_get_near_stressed_v():
    with open(
        "tests/test_ipa_types/get_near_stressed_v.txt", "r", encoding="UTF-8"
    ) as f:
...
def test_make_voice_cons_to_n():
    with open(
        "tests/test_ipa_types/IpaTypes.make_voice_cons_to_n().txt",
        "r",
        encoding="UTF-8",
    ) as f:
...
def test_make_palatal_cons_to_n():
    with open(
        "tests/test_ipa_types/IpaTypes.make_palatal_cons_to_n().txt",
        "r",
        encoding="UTF-8",
    ) as f:
...
def test_make_near_stressed_v_to_n():
    with open(
        "tests/test_ipa_types/IpaTypes.make_near_stressed_v_to_n().txt",
        "r",
        encoding="UTF-8",
    ) as f:
...
def test_generate_all_cons_n():
    with open(
        "tests/test_ipa_types/IpaTypes.generate_all_cons_n().txt", "r", encoding="UTF-8"
    ) as f:
        all_cons_n = f.read()
...
def test_generate_all_vowels_n():
    with open(
        "tests/test_ipa_types/IpaTypes.generate_all_vowels_n().txt",
        "r",
        encoding="UTF-8",
    ) as f:
        all_vowels_n = f.read()
