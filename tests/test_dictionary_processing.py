...
def test_get_unique_of_all_int_from_dict():
    with open("test_dictionary_processing/get_unique_of_all_int_from_dict.txt", "r") as f:
...
def test_make_dict_of_int_from_ipa():
    with open("test_dictionary_processing/make_dict_of_int_from_ipa.txt", "r") as f:
