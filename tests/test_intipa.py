...
@pytest.mark.parametrize("stressed_word, intipa_expected, intipa_processed", [
...
@patch("rhyme_rus.utils.intipa.MySql")
def test_intipa(cur, stressed_word, intipa_expected, intipa_processed):
    cur().cur_execute.return_value = intipa_processed
